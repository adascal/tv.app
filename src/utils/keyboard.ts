...
export type ButtonClickHandler = (e: KeyboardEvent) => void | boolean | Promise<void | boolean>;
...
function listenButton() {
  // @ts-expect-error
  const tizen: any = window['tizen'];
  if (tizen) {
    tizen.inputdevice?.registerKeyBatch?.(Object.keys(KeyboardCodes));
  }
